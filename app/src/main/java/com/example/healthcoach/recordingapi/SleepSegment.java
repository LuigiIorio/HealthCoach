...
public class SleepSegment {
    ...
    public SleepSegment(Context context) {
        ...
        recordingClient.subscribe(dataSource)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Log.d("SleepSegment", "Sleep segment recording started");
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(Exception e) {
                        Log.e("SleepSegment", "Failed to start sleep segment recording", e);
                    }
                });
    }
    ...
    public void stopRecording(Context context) {
        ...
        recordingClient.unsubscribe(dataSource)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Log.d("SleepSegment", "Sleep segment recording stopped");
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(Exception e) {
                        Log.e("SleepSegment", "Failed to stop sleep segment recording", e);
                    }
                });
    }
}
